...
namespace AspComet
{
    ...
    public static class MessageExtensions
    {
        ...
        public static T GetData<T>(this Message message, string key)
        {
            ...
            if (message.data is JObject)
                data = (Dictionary<string, object>)JsonConvert.DeserializeObject<IDictionary<string, object>>(message.data.ToString());
            else if (message.advice != null)
                data = (Dictionary<string, object>)message.data;
        ...
        {
            Dictionary<string, object> advice =null;
            if (message.advice is JObject)
                advice = (Dictionary<string, object>)JsonConvert.DeserializeObject<IDictionary<string, object>>(message.advice.ToString());
            else if (message.advice != null)
                advice = (Dictionary<string, object>)message.advice;
        ...
        public static T GetExt<T>(this Message message, string key)
        {
            ...
            if (message.ext is JObject)
            {
                ext = (Dictionary<string, object>)JsonConvert.DeserializeObject<IDictionary<string, object>>(message.ext.ToString());
            }else if(message.ext != null)
            {
                ext = (Dictionary<string, object>)message.ext;
            }
            if (ext == null || !ext.ContainsKey(key)) return default(T);
            if (ext[key] is JObject) return (T)JsonConvert.DeserializeObject<T>(ext[key].ToString());
            return (T) ext[key];
        }
